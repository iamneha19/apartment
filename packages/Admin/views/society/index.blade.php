@section('title', 'Society Configurations')
@section('panel_title', 'Society Configurations')
@section('content')
...
//                };
            ...
            google.maps.event.addDomListener(window, 'load', initialize(19.1177, 72.8836));
            ...
            $scope.map = function() {
                ...
                $http.get(generateUrl('society_info'))
               .then(function(response) {  
                var map =response.data.response.data.address +' '+ ','+response.data.response.data.city+' '+','+response.data.response.data.state+' '+ ','+response.data.response.data.pincode;
                $scope.getCities($scope.society.state_id);
                $http.get("https://maps.googleapis.com/maps/api/geocode/json?address="+map+"&key=AIzaSyDM1FfKl1JiAjQXLzyDYURJbZiF5XalZ_g"
                        )
                .then(function(response) {
    ...
    <div class="col-lg-12" ng-controller="SocietyInfoCtrl" >
        ...
        <!-- <ul class="nav nav-tabs" role="tablist"> -->
          <!-- <li role="presentation" class="active"><a href="#society_info" aria-controls="profile" role="tab" data-toggle="tab">Society Info</a></li> -->
          <!--<li role="presentation"><a href="#parking" aria-controls="messages" role="tab" data-toggle="tab">Parking</a></li>-->
          <!--<li role="presentation"><a href="#google_map" aria-controls="messages" role="tab" data-toggle="tab">Google Map</a></li>-->
       <!--  </ul> -->
        
        <!-- Tab panes -->
        <div class="tab-content">
        <div role="tabpanel" class="tab-pane active" id="society_info">
                <div class="row">
                    <div class="col-lg-6">
                        <form id="society-form" method="post" action="">
                            <div class="form-group">
                                 <label class="form-label">Society Name</label>
                                 <input type="text" class="form-control" name = "name" maxlength="150" value="@{{society.name}}"  placeholder="Society Name">
                            </div>            
                            <div class="form-group">
                    ...
                    <div class="col-lg-12">
                        <form class="form-horizontal" id="open-category-form" method="post" action="">
                            <div class="form-group">
                                ...
                                <div class="col-xs-2">
                                     <button type="submit" ng-disabled="openCategory_data ? 1:0" class="btn btn-success">Add</button>
<!--                                     </div>
                                <div class="col-xs-2">
                                     <button type="submit" ng-enabled="openCategory_data ? 1:0" class="btn btn-success">Delete</button>-->
                            ...
                            <form class="form-horizontal" id="still-category-form" method="post" action="">
                                <div class="form-group">
                                  <label class="col-sm-2 control-label">Still</label>
                                  <div class="col-xs-2">
                                  ...
                                  <div class="col-xs-2">
                                         <button type="submit" ng-disabled="stillCategory_data ? 1:0" class="btn btn-success">Add</button>
                            ...
                            <form class="form-horizontal" id="garage-category-form" method="post" action="">
                                <div class="form-group">
                                  ...
                                  <div class="col-xs-2">
                                      <input type="text" class="form-control" name="total_slot" maxlength="4" value="@{{garageCategory_data.total_slot}}" ng-readonly="garageCategory_data ? 1:0" placeholder="Slots">
                                  </div>
                                  <div class="col-xs-2">
                                      <input type="text" class="form-control" name="slot_name_prefix" value="@{{garageCategory_data.slot_name_prefix}}" ng-readonly="garageCategory_data ? 1:0" placeholder="Initials">
                                  </div>
                                   <div class="col-xs-2">
                                  ...
                                  <div class="col-xs-2">
                                         <button type="submit" ng-disabled="garageCategory_data ? 1:0" class="btn btn-success">Add</button>
                            ...
                            <form class="form-horizontal" id="single-category-form" method="post" action="">
                                <div class="form-group">
                                  ...
                                  <div class="col-xs-2">
                                         <button type="submit" ng-disabled="singleCategory_data ? 1:0" class="btn btn-success">Add</button>
                            ...
                            <form class="form-horizontal" id="multiple-category-form" method="post" action="">
                                <div class="form-group">
                                  <label class="col-sm-2 control-label">Multiple Stacked</label>
                                    ...
                                    <div class="col-xs-2">
                                         <button type="submit" ng-disabled="multipleCategory_data ? 1:0" class="btn btn-success">Add</button>
