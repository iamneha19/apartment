@section('title', 'Notice') @section('panel_title', 'Notice')
@section('head')
...
<div class="col-lg-12" ng-controller="NoticeCtrl">
	<div class="row form-group">
		<div class="col-md-12">
			<button class="btn btn-primary redirect pull-right"
				data-url="{{ 'notice/print/' . $id }}">
				<strong> PRINT</strong>
			</button>



			<a class="btn btn-primary" href="{{ route('admin.notice.old') }}"><< Back to Notices</a>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-12" ng-show="notice.title">
			...
			<br><br><br>
			<p>
				<span class="highlight"><strong>By :</strong></span>@{{notice.first_name}}
				@{{notice.last_name}}
			</p>
			<div class='clear-both'></div>
			<p>
				<span class="highlight"><strong>Posted On :</strong></span>@{{notice.created_at |
				date:'dd-MMM-yyyy H:mm a' }}
			</p>
			<p>
				<span class="highlight"><strong>Expiry On :</strong></span>@{{notice.expiry_date |
				date:'dd-MMM-yyyy' }}
			</p>
			<div class='clear-both'></div>
		</div>
