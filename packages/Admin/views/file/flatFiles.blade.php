    ...
    <script type="text/javascript">
        app.controller("fileCtrl", function(paginationServices,$scope,$http,$filter) {
            ...
            $scope.getFiles = function(folder_id,offset,limit,search) {
               ...
               var request_url = generateUrl('/flat_file/list',options);
                $http.get(request_url)
                .success(function(result, status, headers, config) {
    ...
    <div class="col-lg-12" ng-controller="fileCtrl" >
        <div class="row form-group">
            ...
            <div class="col-md-12">
                ...
                <a class="btn btn-primary" href="{{route('admin.flat_documents')}}" class="pull-left" ><< Back to folders</a>
            ...
            <div class="col-md-12"> 
                <table class="table table-bordered">
                    ...
                    <tbody >
						   ...
						   <tr   id="areamsg" style="display:none;">
                               <td colspan="4" style="font-weight: bold;"  >No Data Found.</td>
                           </tr>
