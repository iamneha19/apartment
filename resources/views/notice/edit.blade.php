        ...
        <div class="row">
            <div class="col-lg-12">
                    <form id="notice-form" method="post" action="">
                          ...
                          <label class="form-label">Notice Type</label>
                            <div class="form-group type-radio-group">
                                <div class="radio-inline">
                                    <label>
                                        <input type="radio" name="type" ng-checked="(notice.type == 1) ? 1 : 0 "   value="1" >
                                        Administration Notice
                                    </label>
                                </div>
                                <div class="radio-inline">
                                    <label>
                                        <input type="radio" name="type" ng-checked="(notice.type == 2) ? 1 : 0 "   value="2" >
                                        General Notice
                                    </label>
                                </div>
                                <div class="radio-inline">
                                    <label>
                                        <input type="radio" name="type" ng-checked="(notice.type == 3) ? 1 : 0 "   value="3" >
                        ...
                        <a class="btn btn-primary" href="{{ route('notice') }}" >Cancel</a>
                    </form>
