@extends('layouts.default') @section('title','Help Desk')
 ...
 $('#search_open_admin').show();
  ...
  jQuery('#loader').hide();
		...
		$scope.getIssues = function(offset,limit,sort,sort_order,search,issueType) {
            ...
            var options = {offset:offset,limit:limit,sort:sort,sort_order:sort_order,issueType:issueType,search:search};
	...
	<div ng-if="ticketView == false">
        ...
        <div class="row form-group">
					<div class="col-md-6">
						...
						<b style="margin-left:15px;">Issue Type: </b><select id='issue_type'  name="issue_type" ng-model="issue_type" ng-change="changeIssueType()" style="height: 30px;width: 100px;">
                ...
                <tr>
                  ...
                  <span class="sortorder" ng-show="predicate === 'ticket_status'"
                          ng-class="{reverse:reverse}"></span></th>
<!--				   <th><a href="" ng-click="order('type')">Type of Issue</a>
                  <span class="sortorder" ng-show="predicate === 'type'"
                          ng-class="{reverse:reverse}"></span></th>		  -->
				...
				<tr ng-if="pagination.total > 0" ng-repeat="issue in issues">
								...
								<td>@{{issue.flat}}</td>
								<td ng-show="issue.ticket_status == 'Progress'">WIP</td>
        ...
        <div ng-click="show()"role="tabpanel" class="tab-pane" id="resolved">
					<table class="table table-bordered">
						<thead>
							<tr>
                        <th>Sr No.</th>
                        ...
                        <th><a href="" ng-click="order('category_name')">Category</a>
                        <span class="sortorder" ng-show="predicate1 === 'category_name'"
                                ng-class="{reverse:reverse1}"></span></th>
                        <th  style="width: 150px;"><a href="" ng-click="order('issue')">Issue</a>
                        <span class="sortorder" ng-show="predicate1 === 'issue'"
                                ng-class="{reverse:reverse1}"></span></th>
                        <th style="width: 155px;"><a href="" ng-click="order('updated_at')">Closed On</a>
                        <span class="sortorder" ng-show="predicate1 === 'updated_at'"
                                ng-class="{reverse:reverse1}"></span></th>
                        <th><a href="" ng-click="order('flat_no')">Flat</a>
                        <span class="sortorder" ng-show="predicate1 === 'flat_no'"
                                ng-class="{reverse:reverse1}"></span></th>
                        <th><a href="" ng-click="order('ticket_status')">Status</a>
                        <span class="sortorder" ng-show="predicate1 === 'ticket_status'"
                                ng-class="{reverse:reverse1}"></span></th>

							</tr>
						</thead>
						<tbody>
                <tr ng-if="closedIssues.length < 1">
                      <td colspan="10" style="font-weight: bold;" id="dataCheckClosed1">Fetching Data...</td>
                </tr>
							<tr ng-if="closedIssues" ng-repeat="issue in closedIssues">
								<!--<td>@{{$index + 1 + (pagination2.currentPage * 5) - 5}}</td>-->
                                 <td>@{{issue.id}}</td>
								<td>@{{issue.category_name}}</td>
								<td><a href="javascript:void(0)" ng-click="showTicket()">@{{issue.issue}}</a></td>
          ...
          <div>
            <div id="pagination-demo" ng-if="pagination2.total > 0" class="row">
                  <div class="col-lg-12">
                      <ul class="pagination pagination-sm" ng-show="(pagination2.pageCount) ? 1 : 0">
                          <li ng-class="pagination2.prevPageDisabled()">
                            <a href ng-click="pagination2.prevPage()" title="Previous"><i class="fa fa-angle-double-left"></i> Prev</a>
                          </li>
                          <li ng-repeat="n in pagination2.range()" ng-class="{active: n == pagination2.currentPage}" ng-click="pagination2.setPage(n)">
                            <a href>@{{n}}</a>
                          </li>
                          <li ng-class="pagination2.nextPageDisabled()">
                              <a href ng-click="pagination2.nextPage()" title="Next">Next <i class="fa fa-angle-double-right"></i></a>
                          </li>
                      </ul>
                  </div>
            </div>
	...
	<div ng-if="ticketView == true">
		<div class="row">
			<div class="col-md-12" style="margin-bottom: 20px;">
				<a href="javascript:void(0)" class ="btn btn-primary" ng-click="backToTickets()">
          << Back to tickets</a>
			</div>
		</div>
		...
		<div class="row" ng-if="activeTicket.loading == false">
			<div class="col-md-12">
        <p>
          <strong>Ticket No: #@{{activeTicket.data.id}}</strong>
        </p>
				<p>
				...
				<p>
					<strong>By: </strong> @{{activeTicket.data.first_name}}
				</p>
				<p>
					...
					<div class="modal-body">
						...
						<div class="form-group marginSetter">
							...
							<select class="form-control" id="flat" name="flat"
								...
								<option value="{{Session::get('user.flat_id')}}">{{Session::get('user.flat_no')}}</option>
							</select> <label class="error"
