...
//                var records = $.param($( this ).serializeArray());
                ...
                .then(function(response) {
                    $('#change_pwd-form').find('button[type=submit]').attr('disabled',false);
                    $('#change_pwd-form').find('button[type=submit]').text('Update');
            ...
            <div class="col-lg-6">
                <form id="change_pwd-form" method="post" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type ="password" class="form-control" id="old_pwd" name="old_password">
                    </div>
                    <div class="form-group">
